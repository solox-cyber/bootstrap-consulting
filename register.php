            ...
            <div class="col-md-6 text-center text-lg-end">
                <div class="position-relative d-inline-flex align-items-center  text-white top-shape px-5">
                    <div class="me-3 pe-3 border-end py-2">
                        <p class="m-0"  style="color:#f56c73!important"><i class="fa fa-envelope-open me-2"></i><a href="mailto:info@bootstrapconsulting.net">info@bootstrapconsulting.net</a></p>
                    </div>
                    <div class="py-2">
                        <p class="m-0" style="color:#222!important"><i class="fa fa-phone-alt me-2"  style="color:#222!important"></i>+234 806 7415659</p>
                    </div>
                </div>
            </div>
        </div>
